...
const static std::string TEST_NAME = "ChaCha20-Poly1305 decrypt, authenticate ";
...
int main() {
    ...
    ChaCha20_Poly1305::aead_decrypt(
      recovered_text, recover_tag, cipherText, sizeof(cipherText), AAD, sizeof(AAD), chacha20key, nonce + 4, nonce
    );
