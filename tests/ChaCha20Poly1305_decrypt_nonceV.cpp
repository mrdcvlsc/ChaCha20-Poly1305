...
const static std::string TEST_NAME = "ChaCha20-Poly1305 nonce version decrypt, authenticate ";
...
int main() {
    ...
    unsigned char cipherText[] = {
      ...
      0xdf, 0x99, 0x7b, 0x71, 0x4d, 0x6c, 0x6f, 0x2c, 0x29, 0xa6, 0xad, 0x5c, 0xb4, 0x02, 0x2b, 0x02, 0x70, 0x9b};
    ...
    unsigned char AAD[] = {0xf3, 0x33, 0x88, 0x86, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x4e, 0x91};

    unsigned char receiveTag[] = {0xee, 0xad, 0x9d, 0x67, 0x89, 0x0c, 0xbb, 0x22,
                                  0x39, 0x23, 0x36, 0xfe, 0xa1, 0x85, 0x1f, 0x38};

    // ANSWERS
    unsigned char *recover_tag = new unsigned char[sizeof(receiveTag)];
    unsigned char *recovered_text = new unsigned char[sizeof(cipherText)];

    ChaCha20_Poly1305::aead_decrypt(
      recovered_text, recover_tag, cipherText, sizeof(cipherText), AAD, sizeof(AAD), chacha20key, nonce
    );

    ASSERT_ARRAY<unsigned char>(recover_tag, receiveTag, sizeof(receiveTag), "Poly1305 mac/tag ", TEST_RESULTS);
    ASSERT_ARRAY<unsigned char>(recovered_text, plainText, sizeof(plainText), "ChaCha20 decrypt ", TEST_RESULTS);
