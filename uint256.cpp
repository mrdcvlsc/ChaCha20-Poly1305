...
uint256::uint256(const uint128& msdq, const uint128& lsdq) {
    dqdata = new uint128[2];
    dqdata[0] = msdq;
    dqdata[1] = lsdq;
}
...
// copy constructor
uint256::uint256(const uint256& src) {
    dqdata = new uint128[2];
    dqdata[0] = src.msdq();
    dqdata[1] = src.lsdq();
}
...
// move constructor
uint256::uint256(uint256&& src) noexcept {
    dqdata = src.dqdata;
    src.dqdata = NULL;
}

// copy assignment
uint256& uint256::operator=(const uint256& src) {
    dqdata[0] = src.msdq();
    dqdata[1] = src.lsdq();
    return *this;
}
...
// move assignment
uint256& uint256::operator=(uint256&& src) {
    if(dqdata != NULL)
        delete [] dqdata;
...
uint128& uint256::msdq() { return dqdata[0]; }

/// returns the least significant QUADWORD, or the lower uint64 halve of the uint256.
uint128& uint256::lsdq() { return dqdata[1]; }

/// returns the most significant QUADWORD, or the upper uint64 halve of the uint256.
const uint128& uint256::msdq() const { return dqdata[0]; }

/// returns the least significant QUADWORD, or the lower uint64 halve of the uint256.
const uint128& uint256::lsdq() const { return dqdata[1]; }

bool uint256::isOne() const {
...
bool uint256::operator==(const uint256& roperand) const {
...
uint256 uint256::operator+(const uint256& add) const {
...
uint256& uint256::operator+=(const uint256& add) {
...
uint256 uint256::operator-(const uint256& sub) const {
...
uint256& uint256::operator-=(const uint256& sub) {
...
*/
uint256 uint256::operator*(const uint256& mul) const {
...
*/
uint256& uint256::operator*=(const uint256& mul) {
    *this = *this * mul;
    return *this;
}
...
//     uint256 uint256::ep_div(const uint128& divisor) const {
...
uint256 uint256::ss_div(const uint256& divisor) const {
...
/** long division using bits, shifts and subtract */
uint256 uint256::ss_mod(const uint256& divisor) const {
...
uint256 uint256::operator/(const uint256& divisor) const {
...
uint256 uint256::operator<<(size_t lshift) const {
...
uint256 uint256::operator>>(size_t rshift) const {
...
uint256& uint256::operator<<=(size_t lshift) {
    if(!lshift) { /* Do nothing */ }
    else if(lshift < UINT128BITS) {
...
uint256& uint256::operator>>=(size_t rshift) {
    if(!rshift) { /* Do nothing */ }
    else if(rshift < UINT128BITS) {
...
void uint256::printHex() const {
    printf("0x%016lx%016lx%016lx%016lx\n",msdq().msq(),msdq().lsq(),lsdq().msq(),lsdq().lsq());
}

void uint256::printHex_separated() const {
    printf("0x%016lx:%016lx|%016lx:%016lx\n",msdq().msq(),msdq().lsq(),lsdq().msq(),lsdq().lsq());
}

void uint256::printBits() const {
...
void uint256::printBits_separated() const {
    std::bitset<64> msdq_msq(dqdata[0].msq());
    std::bitset<64> msdq_lsq(dqdata[0].lsq());
